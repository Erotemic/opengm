...
for v in gm.variables():
    ...
    print(" factors depeding on vi=", v, " : ",
          gm.numberOfFactorsOfVariable(v))
...
for f in gm.factorIds():
    ...
    print("isTruncatedSquaredDifference : ",
          gm[f].isTruncatedSquaredDifference())
    print("isAbsoluteDifference : ", gm[f].isAbsoluteDifference())
    print("isTruncatedAbsoluteDifference : ",
          gm[f].isTruncatedAbsoluteDifference())
